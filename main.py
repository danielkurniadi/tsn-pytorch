...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if (epoch + 1) % args.eval_freq == 0 or epoch == args.epochs - 1:
            prec1, _ = validate(val_loader, model, criterion, (epoch + 1) * len(train_loader))
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        if i % args.print_freq == 0:
            ...
            with open(train_logs_file, "a+") as fp:
                fp.write("{0},{1},{loss.val:.4f},{top1.val:.4f},{top5.val:.4f}\n".format(
                    epoch, i, loss=losses, top1=top1, top5=top5))
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        if i % args.print_freq == 0:
            ...
            with open(val_logs_file, "a+") as fp:
                fp.write("{0},{loss.val:.4f},{top1.val:.4f},{top5.val:.4f}\n".format(iter, loss=losses, top1=top1, top5=top5))
...
if __name__ == '__main__':
    with open(train_logs_file, "w+") as fp:
        fp.write("Epoch,Iter,Loss,Prec1,Prec5\n")
    
    with open(val_logs_file, "w+") as fp2:
        fp2.write("Iter,Loss,Prec1,Prec5\n")
