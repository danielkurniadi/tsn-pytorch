...
parser.add_argument('--nclass', default=51, type=int, metavar='N',
                    help='number of total classes')
parser.add_argument('--ext', default='.png', type=str)
parser.add_argument('--img_prefix', default='img', type=str)
...
parser.add_argument('--flow_prefix', default="flow", type=str)
